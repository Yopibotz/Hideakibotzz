...
/////////////////
const BotName = 'HIDEAKIBOTZZ'; 
const instagram = 'https://instagram.com/hideaki.kobayashi_?utm_medium=copy_link'; 
const telegram = 'https://t.me/hideakibotzz'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'Timdak Ada';
//const grupch1 = 'https://chat.whatsapp.com/CW3Nhmt4DDLJSQavAMKHFt'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@hideaki.kobaysahi_')
